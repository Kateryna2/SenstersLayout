$('.js-reviews-list').slick({
    ...
    prevArrow: '<button class="slick-prev" aria-label="Previous" type="button"><img src="../img/arrow-back.png" alt=" "></button>',
    nextArrow: '<button class="slick-next" aria-label="Next" type="button"><img src="../img/arrow-forward.png" alt=" "></button>',
    fade: true,
    infinite: true,
    speed: 1000,
